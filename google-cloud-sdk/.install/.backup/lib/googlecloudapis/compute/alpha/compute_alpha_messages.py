...
class AttachedDisk(messages.Message):
  ...
  diskEncryptionKey = messages.MessageField('CustomerEncryptionKey', 4)
...
class AttachedDiskInitializeParams(messages.Message):
  ...
  sourceImageEncryptionKey = messages.MessageField('CustomerEncryptionKey', 6)
...
class ComputeTargetHttpsProxiesSetSslCertificatesRequest(messages.Message):
  ...
  project = messages.StringField(1, required=True)
  targetHttpsProxiesSetSslCertificatesRequest = messages.MessageField('TargetHttpsProxiesSetSslCertificatesRequest', 2)
  targetHttpsProxy = messages.StringField(3, required=True)


class ComputeTargetHttpsProxiesSetUrlMapRequest(messages.Message):
...
class CustomerEncryptionKey(messages.Message):
  ...
  Fields:
    rawKey: Specifies the customer-supplied encryption key to protect the data
      ...
      Format: 256-bit key material encoded in web-safe Base 64 (RFC4648).
    rsaEncryptedKey: Specifies the customer-supplied encryption key to protect
      ...
      customer-supplied encryption key is provided at creation, then the
      resource will be encrypted using an automatically generated key.
      Format: 256-bit key material RSA encrypted and encoded in web-safe Base
      64 (RFC4648).
    sha256: [Output only] The SHA-256 hash of the customer-supplied encryption
      key that protects this resource.
  """

  rawKey = messages.BytesField(1)
  rsaEncryptedKey = messages.BytesField(2)
  sha256 = messages.BytesField(3)
...
class Disk(messages.Message):
  ...
  diskEncryptionKey = messages.MessageField('CustomerEncryptionKey', 3)
  id = messages.IntegerField(4, variant=messages.Variant.UINT64)
  kind = messages.StringField(5, default=u'compute#disk')
  lastAttachTimestamp = messages.StringField(6)
  lastDetachTimestamp = messages.StringField(7)
  licenses = messages.StringField(8, repeated=True)
  name = messages.StringField(9)
  options = messages.StringField(10)
  selfLink = messages.StringField(11)
  sizeGb = messages.IntegerField(12)
  sourceImage = messages.StringField(13)
  sourceImageEncryptionKey = messages.MessageField('CustomerEncryptionKey', 14)
  sourceImageId = messages.StringField(15)
  sourceSnapshot = messages.StringField(16)
  sourceSnapshotEncryptionKey = messages.MessageField('CustomerEncryptionKey', 17)
  sourceSnapshotId = messages.StringField(18)
  status = messages.EnumField('StatusValueValuesEnum', 19)
  storageType = messages.EnumField('StorageTypeValueValuesEnum', 20)
  type = messages.StringField(21)
  users = messages.StringField(22, repeated=True)
  zone = messages.StringField(23)
...
class Image(messages.Message):
  ...
  id = messages.IntegerField(6, variant=messages.Variant.UINT64)
  imageEncryptionKey = messages.MessageField('CustomerEncryptionKey', 7)
  ...
  sourceDiskEncryptionKey = messages.MessageField('CustomerEncryptionKey', 14)
  sourceDiskId = messages.StringField(15)
...
class Quota(messages.Message):
  ...
  class MetricValueValuesEnum(messages.Enum):
    ...
    INSTANCES = 7
    IN_USE_ADDRESSES = 8
    LOCAL_SSD_TOTAL_GB = 9
    NETWORKS = 10
    ROUTES = 11
    SNAPSHOTS = 12
    SSD_TOTAL_GB = 13
    STATIC_ADDRESSES = 14
    TARGET_HTTP_PROXIES = 15
    TARGET_INSTANCES = 16
    TARGET_POOLS = 17
    TARGET_VPN_GATEWAYS = 18
    URL_MAPS = 19
    VPN_TUNNELS = 20
...
class Scheduling(messages.Message):
  ...
  preemptible = messages.BooleanField(3)
...
class Snapshot(messages.Message):
  ...
  name = messages.StringField(7)
  selfLink = messages.StringField(8)
  snapshotEncryptionKey = messages.MessageField('CustomerEncryptionKey', 9)
  sourceDisk = messages.StringField(10)
  sourceDiskEncryptionKey = messages.MessageField('CustomerEncryptionKey', 11)
  sourceDiskId = messages.StringField(12)
...
class TargetHttpsProxiesSetSslCertificatesRequest(messages.Message):
  ...
  sslCertificates = messages.StringField(1, repeated=True)
