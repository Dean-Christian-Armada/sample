...
class CreateGA(base_classes.BaseAsyncCreator,
  ...
  def CreateRequests(self, args):
    ...
    # The following depends on 'args' having the attribute 'preemptible', which
    # can happen only if AddPreemptibleVmArgs() is called, which in turn can
    # happen only if an appropriate API version is built in and selected.
    ...
    if hasattr(args, 'preemptible') and args.preemptible:
