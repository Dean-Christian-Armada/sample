...
class Cluster(messages.Message):
  ...
  Fields:
    ...
    containerIpv4Cidr: The IP addresses of the container pods in this cluster,
      in  CIDR notation (e.g. 10.96.0.0/14). Leave blank to have one
  ...
  nodeRoutingPrefixSize = messages.IntegerField(11, variant=messages.Variant.INT32)
  numNodes = messages.IntegerField(12, variant=messages.Variant.INT32)
  selfLink = messages.StringField(13)
  servicesIpv4Cidr = messages.StringField(14)
...
class ContainerProjectsZonesTokensGetRequest(messages.Message):
  """A ContainerProjectsZonesTokensGetRequest object.

  Fields:
    clusterName: The name of the specified cluster.
    mainProjectId: The hosted main project from which this request is
      coming.
  ...
  clusterName = messages.StringField(1, required=True)
  mainProjectId = messages.StringField(2, required=True)
  projectNumber = messages.IntegerField(3, required=True)
  zoneId = messages.StringField(4, required=True)
...
class MainAuth(messages.Message):
  ...
  Fields:
    bearerToken: The token used to authenticate API requests to the main.
      The token is be included in an HTTP Authorization Header included in all
...
class Token(messages.Message):
  ...
  Fields:
    ...
    expiryTimeSeconds: The expiration time of the token in seconds since the
      unix epoch.
  """

  accessToken = messages.StringField(1)
  expiryTimeSeconds = messages.IntegerField(2)
