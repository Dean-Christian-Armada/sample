...
class CsvOptions(messages.Message):
  """A CsvOptions object.
  ...
  encoding = messages.StringField(3)
  fieldDelimiter = messages.StringField(4)
  quote = messages.StringField(5)
  skipLeadingRows = messages.IntegerField(6, variant=messages.Variant.INT32)
...
class Dataset(messages.Message):
  ...
  defaultTableExpirationMs = messages.IntegerField(4)
  description = messages.StringField(5)
  etag = messages.StringField(6)
  friendlyName = messages.StringField(7)
  id = messages.StringField(8)
  kind = messages.StringField(9, default=u'bigquery#dataset')
  lastModifiedTime = messages.IntegerField(10)
  location = messages.StringField(11)
...
class ExternalDataConfiguration(messages.Message):
  ...
  csvOptions = messages.MessageField('CsvOptions', 2)
  ignoreUnknownValues = messages.BooleanField(3)
  maxBadRecords = messages.IntegerField(4, variant=messages.Variant.INT32)
  schema = messages.MessageField('TableSchema', 5)
  sourceFormat = messages.StringField(6)
  sourceUris = messages.StringField(7, repeated=True)
...
class JobConfigurationLoad(messages.Message):
  ...
  projectionFields = messages.StringField(9, repeated=True)
  quote = messages.StringField(10)
  schema = messages.MessageField('TableSchema', 11)
  schemaInline = messages.StringField(12)
  schemaInlineFormat = messages.StringField(13)
  skipLeadingRows = messages.IntegerField(14, variant=messages.Variant.INT32)
  sourceFormat = messages.StringField(15)
  sourceUris = messages.StringField(16, repeated=True)
  writeDisposition = messages.StringField(17)
...
class JobConfigurationQuery(messages.Message):
  ...
  class TableDefinitionsValue(messages.Message):
    ...
    class AdditionalProperty(messages.Message):
      ...
      value = messages.MessageField('ExternalDataConfiguration', 2)
  ...
  tableDefinitions = messages.MessageField('TableDefinitionsValue', 9)
  useQueryCache = messages.BooleanField(10)
  writeDisposition = messages.StringField(11)
...
class Table(messages.Message):
  ...
  lastModifiedTime = messages.IntegerField(8, variant=messages.Variant.UINT64)
...
class TableDataInsertAllRequest(messages.Message):
  ...
  ignoreUnknownValues = messages.BooleanField(1)
  kind = messages.StringField(2, default=u'bigquery#tableDataInsertAllRequest')
  rows = messages.MessageField('RowsValueListEntry', 3, repeated=True)
  skipInvalidRows = messages.BooleanField(4)
